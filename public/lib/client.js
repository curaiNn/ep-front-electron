...
;(function (window, document, navigator) {
  ...
  if (!window.SwVersion) {
    var onloadFunc = function () {
      ...
      if (!installlerUrl) {
        setTimeout(function () {
          installlerUrl = window.SwVersion && window.SwVersion.getIkeyDownloadUrl()
          console.log('installlerUrl地址为:' + installlerUrl)
  ...
  var isIE6789 = function () {
    ...
    return (
      ...
      (trim_Version === 'MSIE6.0' || trim_Version === 'MSIE7.0' || trim_Version === 'MSIE8.0' || trim_Version === 'MSIE9.0')
    )
  }
  ...
  window.EportClient = {
     ...
     * @param callback
     */
    cusPdfFileAddSign: function (filePath, fileName, datetiem, Edoc_code, Edoc_Name, cookies, passwd, callback) {
      //destDir,fileName,
    ...
    localPdfAddSign: function (filePath, fileName, datetiem, Edoc_code, Edoc_Name, cookies, userpin, callback) {
      //destDir,fileName,
    ...
    localPdfCheckAndAddSign: function (filePath, fileName, datetiem, Edoc_code, Edoc_Name, cookies, callback) {
      //destDir,fileName,
